  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <p style={{ fontSize: '1rem', fontStyle: 'italic', color: '#bbb' }}>
      ...
      <div style={{ 
        ...
        <h2 style={{ color: '#e74c3c', marginTop: 0 }}>Limitations of the Model</h2>
        <ul style={{ 
          paddingLeft: '1.5rem',
          listStyleType: 'none'
        }}>
      ...
      <div style={{ 
        ...
        <h2 style={{ color: '#3498db', marginTop: 0 }}>Intended Use</h2>
        <p>
      ...
      <div style={{ 
        ...
        <h2 style={{ color: '#3498db', marginTop: 0 }}>Data Sources</h2>
        <p>
      ...
      <div style={{ 
        ...
        <h2 style={{ color: '#f39c12', marginTop: 0 }}>No Warranty</h2>
        <p>
